        ...
        stage('Yml file update') {
            steps {
                ...
                withCredentials([usernamePassword(
                        ...
                        script {
                            sh(script: """ yq -i '.spring.datasource.username = ${DB_ID}' /var/jenkins_home/workspace/ComePetHome_master/command-server/src/main/resources/application.yml """)
                            sh(script: """ yq -i '.spring.datasource.password = ${DB_PW}' /var/jenkins_home/workspace/ComePetHome_master/command-server/src/main/resources/application.yml """)
                            sh(script: """ yq -i '.spring.datasource.username = ${DB_ID}' /var/jenkins_home/workspace/ComePetHome_master/query-server/src/main/resources/application.yml """)
                            sh(script: """ yq -i '.spring.datasource.password = ${DB_PW}' /var/jenkins_home/workspace/ComePetHome_master/query-server/src/main/resources/application.yml """)
