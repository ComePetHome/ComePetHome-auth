package com.comepethome.user_command.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.comepethome.user_command.controller")) // Controller가 들어있는 패키지. 이 경로의 하위에 있는 api만 표시됨.
